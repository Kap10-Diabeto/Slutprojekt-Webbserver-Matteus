       ...
       <?php
          ...
          if(mysqli_num_rows($res) > 0){
            while($row = mysqli_fetch_assoc($res)){
              ...
              $posts .= "<div><h2><a href='view_post.php?pid=$id'>$titel</a></h2><h3>$date</h3><p>$content</p></div>"; //Skriver ut innehåll, datum, tid och titel för inlägget!
